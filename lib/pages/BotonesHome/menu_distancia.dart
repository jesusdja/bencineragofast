...
class Menu_distancia extends StatefulWidget {
  @override
  _MenuFABState createState() => _MenuFABState();
}

class _MenuFABState extends State<Menu_distancia> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animateIcon = Tween<double>(begin: 0.0, end: 0.0).animate(_animationController);
